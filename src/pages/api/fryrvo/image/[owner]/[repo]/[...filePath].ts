...
export const GET: APIRoute = async ({ params, request, locals }) => {
  ...
  const token = runtimeEnv.FGIT_TOKEN || import.meta.env.FGIT_TOKEN;
  ...
  const forgejoUrl = `https://git.fryrvo.com/${owner}/${repo}/raw/branch/main/${filePath}`;
  ...
  try {
    ...
    const response = await fetch(forgejoUrl, { headers });
